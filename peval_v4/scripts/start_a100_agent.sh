...
# 
# Usage:
#   For Single A100 (4B-Instruct, 8B, 14B): ./start_a100_agent.sh Qwen/Qwen2.5-14B 1
#   For Multi A100 (32B, 72B)    : ./start_a100_agent.sh Qwen/Qwen2.5-32B 4

MODEL_PATH=${1:-"Qwen/Qwen2.5-32B"}
