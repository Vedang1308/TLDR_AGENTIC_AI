...
class Strategist:
    ...
    def __init__(self, tools_info: list):
        ...
        self.system_prompt = (
            ...
            "STAGE 3: Reconciliation & Roadmapping\n"
            "1. Read the 'write_ahead_memory'. Check the latest status:\n"
            "   - If '[ERROR]': Set 're_plan: true' and retry with fixed parameters ONLY once.\n"
            "   - If '[DATA_MISSING]': THE QUERY RETURNED NO DATA. You MUST pivot. Do NOT repeat the exact same call.\n"
            "   - If '[SUCCESS]': Mark the previous roadmap step as DONE.\n"
            "2. Generate a 'roadmap': A sequence of 5-10 upcoming actions required to complete the user's task (e.g. ['1. Search JFK', '2. Compare Prices', '3. Book', ...]).\n"
            "3. If a parameter for the NEXT step is MISSING, append it to 'gap_manifest_y' and set the next roadmap step to 'Call respond to ask for X'.\n\n"
            ...
            "  \"re_plan\": false,\n"
            "  \"BlackboardSSO\": {\n"
            "    \"roadmap\": [\"1. Action A\", \"2. Action B\", ...],\n"
            "    \"state_s\": {\"user_id\": \"...\", \"origin\": \"...\"},\n"
            "    \"constraint_set_c\": {\"hard\": [...], \"soft\": [...]},\n"
            "    \"gap_manifest_y\": [\"Missing Argument 1\", ...],\n"
            "    \"refined_tactical_plan\": \"The IMMEDIATE next step from the roadmap (e.g. Call book_reservation with ID X or Call respond to ask for Y)\"\n"
            "  }\n"
            "}"
        )
